...
| Large or malicious config input exhausts memory or floods diagnostics. | CLI and CI usage can fail unpredictably. | Define limits for file size, object depth, key count, diagnostics count, path length, and env var count. |
