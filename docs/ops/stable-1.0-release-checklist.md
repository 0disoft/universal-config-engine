...
Status: RC3 Preparation
Candidate: `1.0.0-rc.3`
Stable Version: `1.0.0`
Not Before: RC3 GitHub Release `publishedAt` + 168 hours

## Purpose

Promote the reviewed RC3 package contents without slipping unreviewed runtime,
...
- the five publishable package versions from `1.0.0-rc.3` to `1.0.0`;
...
- [ ] Current UTC time is at or after RC3 `publishedAt` plus `168` hours.
- [ ] `release-policy.json` still names `1.0.0-rc.3` and `168` review hours.
- [ ] No open issue confirms a breaking API, runtime, packaging, or security blocker.
- [ ] npm `next` still points all five packages to `1.0.0-rc.3`.
...
- [ ] The dry-run stable gate installs and smokes exact RC3 registry packages.
...
- [ ] Confirm npm `next` still points all five packages to `1.0.0-rc.3`.
