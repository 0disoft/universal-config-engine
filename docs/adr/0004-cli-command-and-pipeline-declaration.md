...
malformed coercion rules, malformed validator declarations, malformed resource
limits, and malformed file size policies are source-loading failures. The CLI must
not silently ignore unknown source kinds.
