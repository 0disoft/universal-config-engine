...
`v0.1.1` is the
first npm publication baseline, and the current package version is `0.5.0`. CLI
...
Package consumers upgrading from `0.4.0` should follow
[`docs/library/migration-0.5.md`](docs/library/migration-0.5.md).
